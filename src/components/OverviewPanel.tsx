...
function WhyHint({ explain }: { explain: MetricExplanation }) {
  return (
    <span className="ov-why" tabIndex={0} role="button" aria-label={`Vì sao ${explain.label}`}>
      <span className="ov-why-trigger">Vì sao?</span>
      <span className="ov-why-pop" role="tooltip">
  ...
  return (
    <div className="overview-page">
      <header className="overview-header">
        <div>
          ...
          <p className="overview-sub">
            Kéo các thanh trượt bên trái và xem kết quả đổi theo — ai được lợi, ai phải trả
            giá khi đăng cai World Cup.
          </p>
        </div>
      ...
      <section className="ov-mln-banner">
        <span className="ov-mln-banner-icon" aria-hidden="true">
          ⚖️
        </span>
      ...
      <div className="overview-grid">
        ...
        <main className="panel ov-outcomes">
          ...
          <p className="ov-mln-contrast">
            ...
            FIFA và giới đầu tư đứng bên <strong>thu</strong>; nước chủ nhà, người đóng thuế
            và người lao động đứng bên <strong>trả</strong>. Khoảng cách đó chính là bất
            bình đẳng phân phối.
          </p>
          ...
          <section className="ov-echo panel-inner">
            ...
            <div className="ov-echo-primary">
              <div className="ov-echo-match">Giống {outcome.realWorldEcho.match}%</div>
              <div>
                <strong>
